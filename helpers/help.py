...
/remind <duration> <text> - set a timer to send <text> after <duration>
Example: /remind 30m important text! - will send 'important text!' after 30 minutes
...
/rand
قم بالحصول على عدد عشوائي بين رقمين تدخلهم بعد الأمر بينهما مسافة
